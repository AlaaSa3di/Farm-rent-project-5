                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    const fileLinks = files.map((file) => {
                      // Here, you need to upload the file to your cloud storage and retrieve its URL
                      return URL.createObjectURL(file); // This is just for local preview, you will need to replace this with a proper cloud upload logic
                    });
                    setNewProperty({
                      ...newProperty,
                      images: fileLinks,
